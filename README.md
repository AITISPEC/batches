...
| `HUNT_PORTS_NEW.bat` | Интерактивное меню для управления правилами брандмауэра Hunt: Showdown 1896 (порты: TCP 61088, 20000-20099). |
| `HUNT_PORTS_OLD.bat` | Интерактивное меню для управления правилами брандмауэра классической Hunt: Showdown (порты: TCP 3074, 3478, 4379-4380, 27000-27050). |
### 📁 NIRcmd
| Файл | Описание |
|------|----------|
...
| `AITISPEC Repair-Services-Win-11.bat` | Восстанавливает автоматический запуск системных служб Windows 11. Устанавливает тип запуска `Auto` и запускает все критические службы (от CryptSvc до XboxNetApiSvc). Выводит цветной отчёт о статусе каждой службы. Требует права администратора. |
### 📁 py-scripts
| Файл | Описание |
|------|----------|
